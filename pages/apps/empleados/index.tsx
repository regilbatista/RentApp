...
import { apiGet } from '@/lib/api/admin';
        ...
        useEffect(() => {
            setRecordsData(() => {
                return initialRecords.filter((item: any) => {
                    return (
                        item.nombre.toString().includes(search.toLowerCase()) ||
                                    ...
                                    render: (row: any) => (
                                        <div className="mx-auto flex w-max items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                // onClick={() => {
                                                //     deleteBTN.status ? showConfirm(() => deleteItem(row)) : deleteItem(row);
                                                // }}
                                            >
